		...
		success : function(data) {
			...
			for (i = 0; i < all_predicates.length; i++) {
				if (pred_list["predicates"][i]["subj"][0] == print.entity) {
					$("#" + id).children("table").append("<tr><td>" + label(pred_list["predicates"][i]["pred"]) + "&nbsp;&nbsp;&nbsp;&nbsp;</td><td><a class=\"" + id + " " + "click\" id=\"" + pred_list["predicates"][i]["obj"][0] + "\" href=\"#" + pred_list["predicates"][i]["obj"][0] + "\">" + label(pred_list["predicates"][i]["obj"][0]) + "</a></td></tr>");
